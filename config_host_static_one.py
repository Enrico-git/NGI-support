                    ...
                    while True:
                        ...
                        if test.error == None:
                            ...
                            if self.gender.lower() == 'test' and self.hostname == 'h0':
                                ...
                                filename = 'iperf3_Mb'+str(Mbps)+'.json'
...
#python3 /NGI-support-main/config_host_static_one.py train 1 h0 192.168.0.2,192.168.0.4,192.168.0.9,192.168.0.11,192.168.0.15,192.168.0.17,192.168.0.30,192.168.0.32,192.168.0.37,192.168.0.39
#python3 /NGI-support-main/config_host_static_one.py test 1 h0 192.168.0.2,192.168.0.4,192.168.0.9,192.168.0.11,192.168.0.15,192.168.0.17,192.168.0.30,192.168.0.32,192.168.0.37,192.168.0.39
